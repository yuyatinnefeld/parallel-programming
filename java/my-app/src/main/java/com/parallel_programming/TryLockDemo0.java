/**
 * Two Shopper8s adding items to a shared notepad
 */
...
class Shopper8 extends Thread {

    private int itemsToAdd = 0; // items this Shopper8 is waiting to add
    private static int itemsOnNotepad = 0; // total items on shared notepad
    private static Lock pencil = new ReentrantLock();

    public Shopper8(String name) {
        this.setName(name);
    }
...
public class TryLockDemo0 {
    public static void main(String[] args) throws InterruptedException {
        Thread barron = new Shopper8("Barron");
        Thread olivia = new Shopper8("Olivia");
